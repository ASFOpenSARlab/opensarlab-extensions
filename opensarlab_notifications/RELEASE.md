# Making a new release of opensarlab_notifications
...
```bash
python -m pip install --extra-index-url https://testpypi.python.org/pypi opensarlab-notifications==<your current test version>
```
