...
```bash
pip install opensarlab_doc_link
```
...
```bash
pip uninstall opensarlab_doc_link
```
...
# Change directory to the opensarlab_doc_link directory
...
folder is located. Then you can remove the symlink named `opensarlab_doc_link` within that folder.
